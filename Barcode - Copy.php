	...
	*/
	...
	class BARCODE
	{
		...
		function BARCODE($encoding="EAN-13")
		{
			 ...
			 */
			$this->_font=$_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR."inc".DIRECTORY_SEPARATOR."dompdf".DIRECTORY_SEPARATOR."lib".DIRECTORY_SEPARATOR."fonts".DIRECTORY_SEPARATOR."arialbd.ttf";;
